...
########################################################################
# Filename    : __gui.py
# Description : gui controller for master node
# Author      : Man'O'AR
...
from ..utils.__utils_objects import AVAILABLE_TOPICS, OPERATOR, DRONES_NAMES
from ..components.__display_gui import DisplayWindow
...
class Operator( Node ):
        ...
        def __init__( self, Master=None, **kwargs):
            ...
            self._operator_type = OPERATOR.MASTER.value
            ...
            for i in range( len( DRONES_NAMES ) ):
                ...
                if( i == 0): continue
                    ...
                    sub_sensor = self.create_subscription(
                        String,
                        f"/operator_{drone_index}/{AVAILABLE_TOPICS.SENSOR.value}",
        ...
        def _listen_drones_sensors( self ):
            ...
            for i in range( len( DRONES_NAMES ) ):
                ...
                if( i == 0): continue
                    ...
                    sub_sensor = self.create_subscription(
                        String,
                        f"/drone_{drone_index}/{AVAILABLE_TOPICS.SENSOR.value}",
        ...
        def _remap_video_subscriber( self ):
            ...
            if self._drone_index != None and self._drone_index != -1:
                ...
                self._sub_video = self.create_subscription(
                    CompressedImage, 
                    f"/drone_{self._drone_index}/{AVAILABLE_TOPICS.STREAM.value}", 
        ...
        def _operator_sensors_datas( self, msg ): 
            ...
            if( "index" in operator_sensors and "datas" in operator_sensors ):
                self._master._gui.OnDronesDatas( operator_sensors["index"], operator_sensors["datas"] )
...
class App:
    ...
    def ros_thread(self):
        ...
        self._node = Operator(Master=self) 
